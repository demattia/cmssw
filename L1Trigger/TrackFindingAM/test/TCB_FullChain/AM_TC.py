...
process.TTTracksTAMUFromTC.CutOnPrincipals            = cms.bool(True)

# Customise DR for TC
process.DuplicateRemovalTAMU.TTTrackName              = cms.InputTag("MergeFITOutput", "AML1Tracks")
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TC_output_INDEX.root'),
...
process.L1AMTC_FIT_DR_steps = cms.Path(process.TT_TC_FIT_DR_FromPatternswStubs)
process.endjob_step          = cms.EndPath(process.endOfProcess)
process.RAWSIMoutput_step    = cms.EndPath(process.RAWSIMoutput)

process.schedule = cms.Schedule(process.L1AMTC_FIT_DR_steps,process.endjob_step,process.RAWSIMoutput_step)
