...
Source_Files = cms.untracked.vstring(INPUT_FILE_LIST
	)
process.source = cms.Source("PoolSource", fileNames = Source_Files)

process.TFileService = cms.Service("TFileService", fileName = cms.string('Ntuple_INDEX.root'), closeFileFast = cms.untracked.bool(True))
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackNtupleMaker',
                                       ...
                                       # Tracks
                                       L1TrackInputTag = cms.InputTag("MergeFITCBOutput", "AML1Tracks"),
                                       MCTruthTrackInputTag = cms.InputTag("TTTrackAssociatorFromPixelDigisCBFIT", "AML1Tracks"),
                                       )
