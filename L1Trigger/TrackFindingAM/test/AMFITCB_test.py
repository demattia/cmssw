...
process.TTStubAssociatorFromPixelDigis.TTStubs        = cms.VInputTag( cms.InputTag("MergeFITCBOutput", "StubInTrack"))
...
process.TTTrackAssociatorFromPixelDigis.TTTracks      = cms.VInputTag( cms.InputTag("MergeFITCBOutput", "AML1Tracks"))
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('AMFITCB_output.root'),
...
# Keep the FIT output
process.RAWSIMoutput.outputCommands.append('keep  *_*_*_AMFIT3')
...
process.L1AMFIT_step         = cms.Path(process.TTTracksFromCBswStubs)
