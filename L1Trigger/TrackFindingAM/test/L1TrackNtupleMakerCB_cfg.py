...
process.TFileService = cms.Service("TFileService", fileName = cms.string('TTbar_PU140_CB.root'), closeFileFast = cms.untracked.bool(True))
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackNtupleMaker',
                                       ...
                                       MCTruthTrackInputTag = cms.InputTag("TTTrackAssociatorFromPixelDigis", "AML1CBs"),
                                       )
